...
#include "RecallVertexAnimInstanceProcessors.generated.h"

UCLASS()
class URecallVertexAnimInstanceInitializer : public UMassObserverProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallVertexAnimInstanceRepresentationProcessor : public UMassProcessor
{
	GENERATED_BODY()
...
private:
	...
	TSharedPtr<struct FRecallVertexAnimInstanceRepresentationCacheManager> CacheManager;
};
