...
#include "RecallVertexAnimProcessors.generated.h"

UCLASS()
class URecallVertexAnimInitializer : public UMassObserverProcessor
{
	GENERATED_BODY()
...
UCLASS()
class URecallAbilityAnimationVertexAnimRepresentationProcessor : public UMassProcessor
{
	GENERATED_BODY()
